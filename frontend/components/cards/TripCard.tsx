    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            className={cn(
              "h-8 w-8 rounded-lg bg-white/90 backdrop-blur-xs flex items-center justify-center transition-colors shadow-xs",
              isFavorite ? "text-red-500 fill-red-500" : "text-neutral-600 hover:text-red-500"
            )}
          ...
          <button
            ...
            className="h-8 w-8 rounded-lg bg-white/90 backdrop-blur-xs flex items-center justify-center text-neutral-600 hover:text-primary transition-colors shadow-xs"
        ...
        <div className="absolute bottom-3 left-3 right-3">
          ...
          <p className="text-white/90 text-sm flex items-center gap-1 mt-0.5 truncate">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          {budget !== undefined && (
            <span className="font-semibold text-neutral-800 shrink-0 ml-2">
