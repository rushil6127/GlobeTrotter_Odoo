...
export default function ProfilePage() {
  ...
  return (
    <PageShell currentPath="/profile" userName={user?.name ?? undefined}>
      <div className="max-w-3xl mx-auto pt-8 pb-32">
        ...
        <div className="bg-white/85 backdrop-blur-xl rounded-3xl border border-neutral-200/60 shadow-sm p-10 sm:p-14 text-center space-y-5">
          ...
          <div>
            <h1 className="text-2xl font-display font-bold text-neutral-900">Your Profile</h1>
            <p className="text-sm text-neutral-500 mt-2 max-w-md mx-auto leading-relaxed">
              Account settings, preferences, and profile management are coming soon.
              You are signed in as <strong className="text-neutral-800">{user?.email}</strong>.
            </p>
          </div>
